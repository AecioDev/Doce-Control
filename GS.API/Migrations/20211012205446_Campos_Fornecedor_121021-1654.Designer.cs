...
namespace GS.API.Migrations
{
    ...
    [Migration("20211012205446_Campos_Fornecedor_121021-1654")]
    partial class Campos_Fornecedor_1210211654
    {
            ...
            modelBuilder.Entity("GS.API.Models.Fornecedores", b =>
                {
                    ...
                    b.Property<string>("FornecedorCPF")
                        .HasMaxLength(11)
                        .HasColumnType("character varying(11)")
                        .HasColumnName("FornecedorCPF");

                    b.Property<string>("FornecedorContato")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("FornecedorContato");
                    ...
                    b.Property<string>("FornecedorTel1")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("FornecedorTel1");

                    b.Property<string>("FornecedorTel2")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("FornecedorTel2");
            ...
            modelBuilder.Entity("GS.API.Models.Produtos", b =>
                {
                    ...
                    b.Property<decimal?>("ProCustoCompra")
                        .HasColumnType("numeric(15,6)")
                        .HasColumnName("ProCustoCompra");
